    ...
    async function uploadImage() {
        ...
        responseData.detections.forEach(detections => {
            const detectionDiv = document.createElement('div');
            detectionDiv.textContent = 'Detected Objects:';
            
                const detItem = document.createElement('p');
                detItem.textContent = `Object Class: ${detections.class}, Confidence: ${detections.confidence * 100}%`;
    ...
    document.querySelector('form').onsubmit = function(e) {
        ...
        fetch("http://127.0.0.1:10000/detection", {  // Use the current path for the POST request
            method: 'POST',
            body: formData,
        })
